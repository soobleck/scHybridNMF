...
%
% References to Cite regarding this code:
% 1. Jingu Kim and Haesun Park
% Fast nonnegative matrix factorization by active-set-like methods, 
...
% Proceedings of the 2008 Eighth IEEE International Conference on Data Mining (ICDM'08), 353-362, 2008
%
% Written by Jingu Kim (jingu@cc.gatech.edu)
% Copyright 2008 -  by Jingu Kim and Haesun Park, 
...
function [ X,Y,success,numChol,numEq ] = nnlsm_blockpivot( A, B, isInputProd, initial )
